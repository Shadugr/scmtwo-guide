...
| **Лидер группы** | 2 | Лидеры «четвёрок» |
...
!!! abstract "Структура огневой группы (Fireteam)"
    ...
    * **[1] Лидер группы** — полевое командование и координация.

    > **Итого:** 4 бойца в группе. Лидер отряда осуществляет общее руководство обоими группами.
