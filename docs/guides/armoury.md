...
* **Патроны:** Из этого же автомата можно взять обычные патроны к оружию, а из соседнего особые по типу бронебойных, токсиичных и прочее...

!!! danger "Пустое оружие"
    Учтите, что изначально оружие взятое из автомата не заряженное, возьмите магазин и засуньте его в автомат на **`ЛКМ`**
