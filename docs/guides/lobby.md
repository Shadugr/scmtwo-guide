...
| **Лидер отряда** | **Командир отряда (9 чел.)**. Полевой лидер и координатор. | **Высокая** | **Высокая** |
| **Лидер группы** | **Лидер «четвёрки»**. Командует своей огневой группой. | **Средняя** | **Низкая-Высокая** |
...
* **Лидер группы:** Помощник лидера отряда. Командует своей «четвёркой» бойцов для выполнения локальных задач (штурм здания, удержание прохода).
