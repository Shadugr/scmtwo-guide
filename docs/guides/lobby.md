...
![Главное меню: Кнопка настройки персонажей](../img/UHCtdwLc89.png)
*Кнопка настройки персонажей*{: .caption }
...
!!! success "Совет для новичков"
    Для первого вылета мы настоятельно рекомендуем роль **Пехотинца (Rifleman)**. Это универсальный боец с огромным выбором оружия и минимумом ответственности. Идеально, чтобы осмотреться и не подвести команду.
...
| **Сержант огн. группы (Squad Leader)** | **Лидер «четвёрки»**. Командует своей огневой группой. | **Средняя** | **Низкая-Высокая** |
...
* **Штаб-сержант (Section Sergeant):** Главный в отряде. Он видит картину боя целиком и командует всем отрядом.
* **Сержант огневой группы (Squad Leader):** Помощник штаб-сержанта. Командует своей «четвёркой» бойцов для выполнения локальных задач (штурм здания, удержание прохода).
