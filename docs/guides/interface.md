...
!!! tip "Погружение"
    Используйте меню эмоутов (справа сверху) для атмосферы, вызова медика или быстрых выкриков о том, откуда лезут враги.
...
![Скриншот кнопок взаимодействия с оружием](../img/YjencKotLv.png)
...
| :--- | :--- | :--- |
| **1. Зеленый (Помощь)** | Помощь себе и союзникам. | Позволяет осматривать других и пропускать союзников сквозь себя (swap). Не стойте в нем в первом ряду — враги тоже могут пройти! |
| **2. Синий (Разоружение)** | Попытка забрать оружие. | Бесполезен против ксеноморфов (лапы не оторвать). Позволяет забрать ствол у наемника в ближнем бою. |
| **3. Желтый (Захват)** | Хватать и тащить. | Самый частый интент. Незаменим для эвакуации раненых друзей и работы со стационарными орудиями. Безопасен для своих. |
...
* **Планшет:** Список отряда, их огневые группы и текущие роли.
* **Индикатор здоровья (HP):** Зеленый человечек с числом «100».
    !!! danger "Жизнь и смерть"
        Пока индикатор не стал серым с надписью **Dead** — вы живы! Даже если вы в отключке, медики могут вас спасти. Но помните: если вам оторвало голову или сожгло дотла — реанимация не поможет.
* **Голод:** Под ХП находится статус голода. После крио вы хотите жрать, так что одеваемся и идём кушоц.
