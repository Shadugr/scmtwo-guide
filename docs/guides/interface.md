...
* **Планшет (Squad Tablet):** Список вашего отряда, их распределение по огневым группам и текущие роли. 
    * **Функция компаса:** Помимо списка, сам значок планшета на экране показывает направление к вашему лидеру или ключевой точке. Он может указывать на: **Лидера отряда**, **Лидера группы**, **Командира взвода** или **Точку высадки (LZ)**.
...
!!! warning "Почему иконка пустая?"
    ...
    1. В вашей огневой группе нет лидера группы.
    2. Вы сами не назначены ни в одну огневую группу.
    3. Роли лидера отряда или командира взвода вакантны (никто их не занял).
